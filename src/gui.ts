...
export function set_pokemon_name(name: string, side: string) {
...
// 交代の処理
export function change_pokemon(name: string, side: string) {
...
// アウトプットの表示
export function add_output(output: string, turn?: number) {
