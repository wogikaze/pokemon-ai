interface SpeciesData {
  ...
  baseStats: { [stat in "hp" | "atk" | "def" | "spa" | "spd" | "spe"]: number };
  eggGroups: string[];
  weightkg: number;
  prevo?: string;
  baseSpecies?: string;
...
export const Pokedex: { [speciesid: string]: SpeciesData } = {
  ...
  rattataalola: {
    ...
    types: ["あく", "ノーマル"],
    baseStats: { hp: 30, atk: 56, def: 35, spa: 25, spd: 35, spe: 72 },
    abilities: { 0: "くいしんぼう", 1: "はりきり", H: "あついしぼう" },
    heightm: 0.3,
    weightkg: 3.8,
    color: "Black",
    evos: ["Raticate-Alola"],
  ...
  diglettalola: {
    ...
    abilities: { 0: "すながくれ", 1: "カーリーヘアー", H: "すなのちから" },
    heightm: 0.2,
    weightkg: 1,
    color: "Brown",
    evos: ["Dugtrio-Alola"],
  ...
  meowthalola: {
    ...
    abilities: { 0: "ものひろい", 1: "テクニシャン", H: "びびり" },
    heightm: 0.4,
    weightkg: 4.2,
    color: "Blue",
    evos: ["Persian-Alola"],
  ...
  meowthgalar: {
    ...
    abilities: { 0: "ものひろい", 1: "かたいツメ", H: "きんちょうかん" },
    heightm: 0.4,
    weightkg: 7.5,
    color: "Brown",
    evos: ["ニャイキング"],
  ...
  persianalola: {
    ...
    abilities: { 0: "ファーコート", 1: "テクニシャン", H: "びびり" },
    heightm: 1.1,
    weightkg: 33,
    color: "Blue",
    prevo: "Meowth-Alola",
  ...
  growlithehisui: {
    ...
    abilities: { 0: "いかく", 1: "もらいび", H: "いしあたま" },
    heightm: 0.8,
    weightkg: 22.7,
    color: "Brown",
    evos: ["Arcanine-Hisui"],
  ...
  geodudealola: {
    ...
    types: ["いわ", "でんき"],
    baseStats: { hp: 40, atk: 80, def: 100, spa: 30, spd: 30, spe: 20 },
    abilities: { 0: "じりょく", 1: "がんじょう", H: "エレキスキン" },
    heightm: 0.4,
    weightkg: 20.3,
    color: "Gray",
    evos: ["Graveler-Alola"],
  ...
  ponytagalar: {
    ...
    types: ["エスパー"],
    baseStats: { hp: 50, atk: 85, def: 55, spa: 65, spd: 65, spe: 90 },
    abilities: { 0: "にげあし", 1: "パステルベール", H: "きけんよち" },
    heightm: 0.8,
    weightkg: 24,
    color: "White",
    evos: ["Rapidash-Galar"],
  ...
  slowpokegalar: {
    ...
    types: ["エスパー"],
    baseStats: { hp: 90, atk: 65, def: 65, spa: 40, spd: 40, spe: 15 },
    abilities: { 0: "くいしんぼう", 1: "マイペース", H: "さいせいりょく" },
    heightm: 1.2,
    weightkg: 36,
    color: "Pink",
  ...
  slowbrogalar: {
    ...
    abilities: { 0: "クイックドロウ", 1: "マイペース", H: "さいせいりょく" },
    heightm: 1.6,
    weightkg: 70.5,
    color: "Pink",
  ...
  grimeralola: {
    ...
    types: ["どく", "あく"],
    baseStats: { hp: 80, atk: 80, def: 50, spa: 40, spd: 50, spe: 25 },
    abilities: { 0: "どくしゅ", 1: "くいしんぼう", H: "かがくのちから" },
    heightm: 0.7,
    weightkg: 42,
    color: "Green",
    evos: ["Muk-Alola"],
  ...
  marowakalola: {
    ...
    types: ["ほのお", "ゴースト"],
    baseStats: { hp: 60, atk: 80, def: 110, spa: 50, spd: 80, spe: 45 },
    abilities: { 0: "のろわれボディ", 1: "ひらいしん", H: "いしあたま" },
    heightm: 1,
    weightkg: 34,
    color: "Purple",
    prevo: "カラカラ",
  ...
  weezinggalar: {
    ...
    types: ["どく", "フェアリー"],
    baseStats: { hp: 65, atk: 90, def: 120, spa: 85, spd: 70, spe: 60 },
    abilities: { 0: "ふゆう", 1: "かがくへんかガス", H: "ミストメイカー" },
    heightm: 3,
    weightkg: 16,
    color: "Gray",
    prevo: "ドガース",
  ...
  mrmimegalar: {
    ...
    abilities: { 0: "やるき", 1: "バリアフリー", H: "アイスボディ" },
    heightm: 1.4,
    weightkg: 56.8,
    color: "White",
    prevo: "マネネ",
  ...
  taurospaldeacombat: {
    ...
    abilities: { 0: "いかく", 1: "いかりのつぼ", H: "はんすう" },
    heightm: 1.4,
    weightkg: 115,
    color: "Black",
    eggGroups: ["Field"],
  ...
  slowkinggalar: {
    ...
    abilities: { 0: "きみょうなくすり", 1: "マイペース", H: "さいせいりょく" },
    heightm: 1.8,
    weightkg: 79.5,
    color: "Pink",
    prevo: "Slowpoke-Galar",
  ...
  rayquazamega: {
    ...
    abilities: { 0: "デルタストリーム" },
    heightm: 10.8,
    weightkg: 392,
    color: "Green",
    eggGroups: ["Undiscovered"],
    requiredMove: "ガリョウテンセイ",
  },
  ジラーチ: {
    num: 385,
    name: "ジラーチ",
  ...
  arceusbug: {
    ...
    color: "White",
    eggGroups: ["Undiscovered"],
    requiredItems: ["たまむしプレート", "Buginium Z"],
    changesFrom: "アルセウス",
  },
  arceusdark: {
    num: 493,
    ...
    color: "White",
    eggGroups: ["Undiscovered"],
    requiredItems: ["こわもてプレート", "Darkinium Z"],
    changesFrom: "アルセウス",
  },
  arceusdragon: {
    num: 493,
    ...
    color: "White",
    eggGroups: ["Undiscovered"],
    requiredItems: ["りゅうのプレート", "Dragonium Z"],
    changesFrom: "アルセウス",
  },
  arceuselectric: {
    num: 493,
    ...
    color: "White",
    eggGroups: ["Undiscovered"],
    requiredItems: ["いかずちプレート", "Electrium Z"],
    changesFrom: "アルセウス",
  },
  arceusfairy: {
    num: 493,
    ...
    color: "White",
    eggGroups: ["Undiscovered"],
    requiredItems: ["せいれいプレート", "Fairium Z"],
    changesFrom: "アルセウス",
    gen: 6,
  },
  arceusfighting: {
    ...
    color: "White",
    eggGroups: ["Undiscovered"],
    requiredItems: ["こぶしのプレート", "Fightinium Z"],
    changesFrom: "アルセウス",
  },
  arceusfire: {
    num: 493,
    ...
    color: "White",
    eggGroups: ["Undiscovered"],
    requiredItems: ["ひのたまプレート", "Firium Z"],
    changesFrom: "アルセウス",
  },
  arceusflying: {
    num: 493,
    ...
    color: "White",
    eggGroups: ["Undiscovered"],
    requiredItems: ["あおぞらプレート", "Flyinium Z"],
    changesFrom: "アルセウス",
  },
  arceusghost: {
    num: 493,
    ...
    color: "White",
    eggGroups: ["Undiscovered"],
    requiredItems: ["もののけプレート", "Ghostium Z"],
    changesFrom: "アルセウス",
  },
  arceusgrass: {
    num: 493,
    ...
    color: "White",
    eggGroups: ["Undiscovered"],
    requiredItems: ["みどりのプレート", "Grassium Z"],
    changesFrom: "アルセウス",
  },
  arceusground: {
    num: 493,
    ...
    color: "White",
    eggGroups: ["Undiscovered"],
    requiredItems: ["だいちのプレート", "Groundium Z"],
    changesFrom: "アルセウス",
  },
  arceusice: {
    num: 493,
    ...
    color: "White",
    eggGroups: ["Undiscovered"],
    requiredItems: ["つららのプレート", "Icium Z"],
    changesFrom: "アルセウス",
  },
  arceuspoison: {
    num: 493,
    ...
    color: "White",
    eggGroups: ["Undiscovered"],
    requiredItems: ["もうどくプレート", "Poisonium Z"],
    changesFrom: "アルセウス",
  },
  arceuspsychic: {
    num: 493,
    ...
    color: "White",
    eggGroups: ["Undiscovered"],
    requiredItems: ["ふしぎのプレート", "Psychium Z"],
    changesFrom: "アルセウス",
  },
  arceusrock: {
    num: 493,
    ...
    color: "White",
    eggGroups: ["Undiscovered"],
    requiredItems: ["がんせきプレート", "Rockium Z"],
    changesFrom: "アルセウス",
  },
  arceussteel: {
    num: 493,
    ...
    color: "White",
    eggGroups: ["Undiscovered"],
    requiredItems: ["こうてつプレート", "Steelium Z"],
    changesFrom: "アルセウス",
  },
  arceuswater: {
    num: 493,
    ...
    color: "White",
    eggGroups: ["Undiscovered"],
    requiredItems: ["しずくプレート", "Waterium Z"],
    changesFrom: "アルセウス",
  },
  ビクティニ: {
    num: 494,
  ...
  lilliganthisui: {
    ...
    abilities: { 0: "ようりょくそ", 1: "はりきり", H: "リーフガード" },
    heightm: 1.2,
    weightkg: 19.2,
    color: "Green",
    prevo: "チュリネ",
  ...
  basculinbluestriped: {
    ...
    types: ["みず"],
    baseStats: { hp: 70, atk: 92, def: 65, spa: 80, spd: 55, spe: 98 },
    abilities: { 0: "いしあたま", 1: "てきおうりょく", H: "かたやぶり" },
    heightm: 1,
    weightkg: 18,
    color: "Green",
    eggGroups: ["Water 2"],
  ...
  basculinwhitestriped: {
    ...
    types: ["みず"],
    baseStats: { hp: 70, atk: 92, def: 65, spa: 80, spd: 55, spe: 98 },
    abilities: { 0: "びびり", 1: "てきおうりょく", H: "かたやぶり" },
    heightm: 1,
    weightkg: 18,
    color: "Green",
    evos: ["イダイトウ", "Basculegion-F"],
    eggGroups: ["Water 2"],
    gen: 8,
  },
  メグロコ: {
  ...
  braviaryhisui: {
    ...
    abilities: { 0: "するどいめ", 1: "ちからずく", H: "いろめがね" },
    heightm: 1.7,
    weightkg: 43.4,
    color: "White",
    prevo: "ワシボン",
  ...
  meowsticf: {
    ...
    gender: "F",
    baseStats: { hp: 74, atk: 48, def: 76, spa: 83, spd: 81, spe: 104 },
    abilities: { 0: "するどいめ", 1: "すりぬけ", H: "かちき" },
    heightm: 0.6,
    weightkg: 8.5,
    color: "White",
    prevo: "ニャスパー",
  ...
  sliggoohisui: {
    ...
    abilities: { 0: "そうしょく", 1: "シェルアーマー", H: "ぬめぬめ" },
    heightm: 0.7,
    weightkg: 68.5,
    color: "Purple",
    prevo: "ヌメラ",
  ...
  avalugghisui: {
    ...
    abilities: { 0: "がんじょうあご", 1: "アイスボディ", H: "がんじょう" },
    heightm: 1.4,
    weightkg: 262.4,
    color: "Blue",
    prevo: "カチコール",
  ...
  zygardecomplete: {
    ...
    abilities: { 0: "スワームチェンジ" },
    heightm: 4.5,
    weightkg: 610,
    color: "Black",
    eggGroups: ["Undiscovered"],
    requiredAbility: "スワームチェンジ",
    battleOnly: ["ジガルデ", "Zygarde-10%"],
    gen: 7,
  },
  ディアンシー: {
    num: 719,
  ...
  lycanrocmidnight: {
    ...
    abilities: { 0: "するどいめ", 1: "やるき", H: "ノーガード" },
    heightm: 1.1,
    weightkg: 25,
    color: "Red",
    prevo: "イワンコ",
  ...
  toxtricitylowkey: {
    ...
    types: ["でんき", "どく"],
    baseStats: { hp: 75, atk: 98, def: 70, spa: 114, spd: 70, spe: 75 },
    abilities: { 0: "パンクロック", 1: "マイナス", H: "テクニシャン" },
    heightm: 1.6,
    weightkg: 40,
    color: "Purple",
    prevo: "エレズン",
  ...
  indeedeef: {
    ...
    abilities: { 0: "マイペース", 1: "シンクロ", H: "サイコメイカー" },
    heightm: 0.9,
    weightkg: 28,
    color: "Purple",
    eggGroups: ["フェアリー"],
  ...
  squawkabillyyellow: {
    ...
    types: ["ノーマル", "ひこう"],
    baseStats: { hp: 82, atk: 96, def: 51, spa: 45, spd: 51, spe: 92 },
    abilities: { 0: "いかく", 1: "はりきり", H: "ちからずく" },
    heightm: 0.6,
    weightkg: 2.4,
    color: "Yellow",
    eggGroups: ["ひこう"],
  ...
  syclar: {
    ...
    abilities: { 0: "ふくがん", 1: "ゆきがくれ", H: "アイスボディ" },
    heightm: 0.2,
    weightkg: 4,
    color: "Blue",
    evos: ["Syclant"],
  ...
  syclant: {
    ...
    abilities: { 0: "ふくがん", 1: "Mountaineer", H: "アイスボディ" },
    heightm: 1.7,
    weightkg: 52,
    color: "Blue",
    prevo: "Syclar",
  ...
  revenankh: {
    ...
    abilities: { 0: "エアロック", 1: "ヒーリングシフト", H: "だっぴ" },
    heightm: 1.8,
    weightkg: 44,
    color: "White",
  ...
  embirch: {
    ...
    abilities: { 0: "すてみ", 1: "リーフガード", H: "ようりょくそ" },
    heightm: 0.6,
    weightkg: 15,
    color: "Brown",
    evos: ["Flarelm"],
  ...
  flarelm: {
    ...
    abilities: { 0: "いしあたま", 1: "カブトアーマー", H: "しろいけむり" },
    heightm: 1.4,
    weightkg: 73,
    color: "Brown",
    prevo: "Embirch",
  ...
  pyroak: {
    ...
    abilities: { 0: "いしあたま", 1: "カブトアーマー", H: "あまのじゃく" },
    heightm: 2.1,
    weightkg: 168,
    color: "Brown",
    prevo: "Flarelm",
  ...
  breezi: {
    ...
    abilities: { 0: "かるわざ", 1: "マイペース", H: "おみとおし" },
    heightm: 0.4,
    weightkg: 0.6,
    color: "Purple",
    evos: ["Fidgit"],
  ...
  fidgit: {
    ...
    abilities: { 0: "Persistent", 1: "やるき", H: "おみとおし" },
    heightm: 0.9,
    weightkg: 53,
    color: "Purple",
    prevo: "Breezi",
  ...
  rebble: {
    ...
    abilities: { 0: "ふゆう", 1: "ハードロック", H: "スナイパー" },
    heightm: 0.3,
    weightkg: 7,
    color: "Gray",
    evos: ["Tactite"],
  ...
  tactite: {
    ...
    abilities: { 0: "ふゆう", 1: "テクニシャン", H: "スナイパー" },
    heightm: 0.6,
    weightkg: 16,
    color: "Gray",
    prevo: "Rebble",
  ...
  kitsunoh: {
    ...
    abilities: { 0: "おみとおし", 1: "じゅうなん", H: "てつのこぶし" },
    heightm: 1.1,
    weightkg: 51,
    color: "Gray",
    prevo: "Nohface",
  ...
  cyclohm: {
    ...
    abilities: { 0: "りんぷん", 1: "せいでんき", H: "しめりけ" },
    heightm: 1.6,
    weightkg: 59,
    color: "Yellow",
    prevo: "Duohm",
    evoLevel: 43,
    eggGroups: ["ドラゴン", "Monster"],
    gen: 4,
  },
  colossoil: {
    num: -16,
    ...
    abilities: { 0: "Rebound", 1: "こんじょう", H: "きんちょうかん" },
    heightm: 2.6,
    weightkg: 683.6,
    color: "Brown",
    prevo: "Dorsoil",
  ...
  krilowatt: {
    ...
    abilities: { 0: "トレース", 1: "マジックガード", H: "マイナス" },
    heightm: 0.7,
    weightkg: 10.6,
    color: "Red",
    prevo: "Protowatt",
  ...
  voodoll: {
    ...
    abilities: { 0: "ちくでん", 1: "ひらいしん", H: "のろわれボディ" },
    heightm: 1,
    weightkg: 25,
    color: "Brown",
    evos: ["Voodoom"],
  ...
  scratchet: {
    ...
    abilities: { 0: "きもったま", 1: "いたずらごころ", H: "やるき" },
    heightm: 0.5,
    weightkg: 20,
    color: "Brown",
    evos: ["Tomohawk"],
  ...
  tomohawk: {
    ...
    abilities: { 0: "いかく", 1: "いたずらごころ", H: "せいぎのこころ" },
    heightm: 1.27,
    weightkg: 37.2,
    color: "Red",
    prevo: "Scratchet",
  ...
  mollux: {
    ...
    abilities: { 0: "かんそうはだ", H: "はっこう" },
    heightm: 1.2,
    weightkg: 41,
    color: "Pink",
    eggGroups: ["フェアリー", "Field"],
    gen: 5,
  },
  cupra: {
    num: -25,
    ...
    abilities: { 0: "りんぷん", 1: "するどいめ", H: "マジックガード" },
    heightm: 0.5,
    weightkg: 4.8,
    color: "Brown",
    evos: ["Argalis"],
  ...
  aurumoth: {
    ...
    abilities: { 0: "くだけるよろい", 1: "ノーガード", H: "ライトメタル" },
    heightm: 2.1,
    weightkg: 193,
    color: "Purple",
    prevo: "Argalis",
  ...
  brattler: {
    ...
    abilities: { 0: "しゅうかく", 1: "すりぬけ", H: "びびり" },
    heightm: 1.8,
    weightkg: 11.5,
    color: "Brown",
    evos: ["Malaconda"],
  ...
  malaconda: {
    ...
    abilities: { 0: "しゅうかく", 1: "すりぬけ", H: "ひでり" },
    heightm: 5.5,
    weightkg: 108.8,
    color: "Brown",
    prevo: "Brattler",
  ...
  cawdet: {
    ...
    abilities: { 0: "するどいめ", 1: "ちくでん", H: "はとむね" },
    heightm: 0.76,
    weightkg: 25,
    color: "Gray",
    evos: ["Cawmodore"],
  ...
  volkritter: {
    ...
    abilities: { 0: "きけんよち", 1: "すりぬけ", H: "きんちょうかん" },
    heightm: 0.3,
    weightkg: 15,
    color: "Red",
    evos: ["Volkraken"],
  ...
  volkraken: {
    ...
    abilities: { 0: "アナライズ", 1: "すりぬけ", H: "プレッシャー" },
    heightm: 1.3,
    weightkg: 44.5,
    color: "Red",
    prevo: "Volkritter",
  ...
  snugglow: {
    ...
    abilities: { 0: "よびみず", 1: "やるき", H: "テレパシー" },
    heightm: 1.2,
    weightkg: 6,
    color: "Purple",
    evos: ["Plasmanta"],
  ...
  floatoy: {
    ...
    abilities: { 0: "みずのベール", 1: "たいねつ", H: "すいすい" },
    heightm: 0.8,
    weightkg: 1.9,
    color: "White",
    evos: ["Caimanoe"],
  ...
  caimanoe: {
    ...
    abilities: { 0: "みずのベール", 1: "たいねつ", H: "ライトメタル" },
    heightm: 1.4,
    weightkg: 72.5,
    color: "Gray",
    prevo: "Floatoy",
  ...
  naviathan: {
    ...
    abilities: { 0: "こんじょう", 1: "たいねつ", H: "ライトメタル" },
    heightm: 3,
    weightkg: 510,
    color: "Gray",
    prevo: "Caimanoe",
  ...
  crucibelle: {
    ...
    abilities: { 0: "さいせいりょく", 1: "かたやぶり", H: "ヘドロえき" },
    heightm: 1.3,
    weightkg: 23.6,
    color: "Purple",
  ...
  pluffle: {
    ...
    abilities: { 0: "しぜんかいふく", 1: "アロマベール", H: "フレンドガード" },
    heightm: 0.8,
    weightkg: 1.8,
    color: "Pink",
    evos: ["Kerfluffle"],
  ...
  mumbao: {
    ...
    abilities: { 0: "トレース", 1: "ぼうじん", H: "サンパワー" },
    heightm: 1,
    weightkg: 83,
    color: "Brown",
    evos: ["Jumbao"],
  ...
  justyke: {
    ...
    abilities: { 0: "ふゆう", 1: "ぼうだん", H: "せいぎのこころ" },
    heightm: 0.4,
    weightkg: 36.5,
    color: "Brown",
    evos: ["Equilibra"],
  ...
  solotl: {
    ...
    abilities: { 0: "さいせいりょく", 1: "やるき", H: "マジシャン" },
    heightm: 0.6,
    weightkg: 11.8,
    color: "Red",
    evos: ["Astrolotl"],
    eggGroups: ["ドラゴン", "フェアリー"],
    gen: 8,
  },
  astrolotl: {
    num: -57,
  ...
  miasmite: {
    ...
    abilities: { 0: "かがくへんかガス", 1: "かいりきバサミ", H: "ふくがん" },
    heightm: 0.6,
    weightkg: 10.1,
    color: "Green",
    evos: ["Miasmaw"],
  ...
  nohface: {
    ...
    abilities: { 0: "おみとおし", 1: "じゅうなん", H: "きんちょうかん" },
    heightm: 0.5,
    weightkg: 5.9,
    color: "Blue",
    evos: ["Kitsunoh"],
  ...
  dorsoil: {
    ...
    abilities: { 0: "どんかん", 1: "こんじょう", H: "きんちょうかん" },
    heightm: 1.3,
    weightkg: 145,
    color: "White",
    evos: ["Colossoil"],
  ...
  saharascal: {
    ...
    abilities: { 0: "ちょすい", 1: "わるいてぐせ", H: "すなはき" },
    heightm: 1.2,
    weightkg: 48,
    color: "Brown",
    evos: ["Saharaja"],
  ...
  saharaja: {
    ...
    abilities: { 0: "ちょすい", 1: "てんのめぐみ", H: "すなはき" },
    heightm: 2.3,
    weightkg: 303.9,
    color: "White",
    prevo: "Saharascal",
  ...
  ababo: {
    ...
    abilities: { 0: "フェアリースキン", 1: "びびり", H: "マイペース" },
    heightm: 0.5,
    weightkg: 3.5,
    color: "White",
    evos: ["Scattervein"],
  ...
  scattervein: {
    ...
    abilities: { 0: "フェアリースキン", 1: "いかく", H: "マイペース" },
    heightm: 1.5,
    weightkg: 25,
    color: "Pink",
    prevo: "Ababo",
